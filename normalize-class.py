...
while True:
    ...
    try:
        ...
        mq7Ppm_normalized = (mq7Ppm - X_min['mq7Ppm']) / (X_max['mq7Ppm'] - X_min['mq7Ppm'])
        mq135Ppm_normalized = (mq135Ppm - X_min['mq135Ppm']) / (X_max['mq135Ppm'] - X_min['mq135Ppm'])
        mq136Ppm_normalized = (mq136Ppm - X_min['mq136Ppm']) / (X_max['mq136Ppm'] - X_min['mq136Ppm'])
