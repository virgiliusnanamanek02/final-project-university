...
import PySimpleGUI as sg # Untuk membuat GUI
...
def analyze_data():
    ...
    def predict(X):
        ...
        return predicted_output # Hasil prediksi
    ...
    hasil_prediksi = predict(data_test) # Hasil prediksi

    # Membuat grafik probabilitas
    probabilitas = hasil_prediksi[0] # Probabilitas dari hasil prediksi
...
# Menemukan indeks dari probabilitas tertinggi
    ...
    colors[indeks_tertinggi] = 'orange' # Mewarnai probabilitas tertinggi
...
layout = [
    ...
    [sg.Text('Pilih File CSV:', size=(20, 1)), sg.Input(key='file_path', size=(40, 1)), sg.FileBrowse()],
    [sg.Button('Analisis', size=(20, 1)), sg.Button('Exit', size=(20, 1))],
